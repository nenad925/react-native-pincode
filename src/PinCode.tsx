...
export type IProps = {
  ...
  stylePinCodeCircleEmpty?: StyleProp<ViewStyle>
  stylePinCodeCircleText?: StyleProp<ViewStyle>
  stylePinCodeCircleTextEmpty?: StyleProp<ViewStyle>
                ...
                <View style={styles.viewCircles}>
                  {((!this.props.pinCodeVisible ||
                    ...
                    <View
                      ...
                      }, this.props.stylePinCodeCircle, this.props.stylePinCodeCircleEmpty]}
                    >
                      <Text style={[this.props.stylePinCodeCircleText, this.props.stylePinCodeCircleTextEmpty]}>
                        *
                      </Text>
                    </View>
                  )) || (
                    ...
                    >
                      <Text style={this.props.stylePinCodeCircleText}>
                        *
                      </Text>
                    </View>
                  )}
  ...
  render() {
    ...
    return (
      <View
        ...
        {this.props.additionalComponent && this.props.additionalComponent}
