      ...
      <View
        ...
        {this.state.status === PinStatus.choose && (
          <PinCode
            ...
            stylePinCodeCircleEmpty={this.props.stylePinCodeCircleEmpty}
            stylePinCodeCircleText={this.props.stylePinCodeCircleText}
            stylePinCodeCircleTextEmpty={this.props.stylePinCodeCircleTextEmpty}
            ...
            additionalComponent={this.props.additionalComponent || null}
          />
        )}
